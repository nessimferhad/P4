...
<div id="testdiv">
  ...
  for ($i = 0; $i < 3; $i++) : ?>
    <div class="card mb-3 card<?=$i?>">
      <h3 class="card-header card-header<?=$i?>">Card header</h3>
      <div class="card-body card-body<?=$i?>>">
        <h5 class="card-title" card-title<?=$i?>>Special title sample</h5>
        <h6 class="card-subtitle text-muted card-subtitle<?=$i?>">Support card subtitle</h6>
      </div>
      ...
      <div class="card-body card-body<?=$i?>">
        <p class="card-text card-text<?=$i?>">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      </div>
      <ul class="list-group list-group-flush list-group<?=$i?>">
        <li class="list-group-item list-group-item<?=$i?>">Cras justo odio</li>
        <li class="list-group-item list-group-item<?=$i?>">Dapibus ac facilisis in</li>
        <li class="list-group-item list-group-item<?=$i?>">Vestibulum at eros</li>
      </ul>
    </div>
  <?php endfor ?>
</div>